 ...
 */
public class RecyclerViewAdapterThree extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<ListBean.ResultBean.PzshBean.CommodityListBeanX> commodityList;


    public RecyclerViewAdapterThree(Context context, List<ListBean.ResultBean.PzshBean.CommodityListBeanX> commodityList) {
